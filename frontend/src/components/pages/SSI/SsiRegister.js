...
export default function SsiRegister(props) {
  ...
  return (
    <>
    <div style={{background:"#E0FFFF",paddingBottom:"50px"}}>
                  ...
                  <form >
                    ...
                    <div class="row">
                     ...
                     <div class="form-outline">
                      ...
                      <div class="mt-4 pt-2">
                      <button type="submit" class="btn btn-primary btn-block m-2 " onClick={create} >Create </button>
                      <Link to="/home"><button type="submit" class="btn btn-primary btn-block m-2 "  >Cancel</button></Link>
                    </div>
                  </form>
                </div>
              </div>
