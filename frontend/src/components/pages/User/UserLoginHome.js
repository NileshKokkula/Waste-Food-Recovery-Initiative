...
function UserLoginHome() {
    ...
    return (
        ...
        <div style={{paddingBottom:"50px"}}>
            Welcome {us}
            <button style={{float:"right",marginBlock:"10px",marginRight:"50px",backgroundColor:"red"}} onClick={handler}>Logout</button><br/><br/>
          ...
          <SelectionPage st={user.state}></SelectionPage>
        </>
    );
}
