...
function UserRegister() {
  ...
  let [res,setRes]=useState();
    ...
    function create()
    {
      if(fname1 && lname1 && phone1 && email1 && street1 && city1 && dist1 && state1 && pin1 && role1 && pass1 && pass2)
      {
      if(pass1===pass2)
      {
        let user={
    ...
    return (
     <>
      <section class="h-100 h-custom " style={{backgroundColor:"#E0FFFF"}}>
    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-12">
        <div class="card card-registration card-registration-2" style={{borderRadius: "15px"}}>
          <div class="card-body p-0 bg-danger-subtle" >
            <div class="row g-0">
            <div class="col-lg-6">
                <div class="p-5">
                  <h3 class="fw-normal mb-5" style={{color:"black"}}>Registration  for User</h3>
                 ...
                 <div class="row">
                    <div class="col-md-6 mb-4 pb-2">
                      ...
                      <label class="form-label" for="form3Examplev2">First name</label>
                        <input type="text" id="form3Examplev2" class="form-control form-control-lg"  onChange={(e)=>fname1=e.target.value
                        }/>      
                      </div>
                  ...
                  <div class="row">
                    <div class="col-md-6 mb-4 pb-2">
                      ...
                      <label class="form-label" for="form3Examplev2">Password</label>
                        <input type="password" id="form3Examplev2" class="form-control form-control-lg" onBlur={(e)=>pass1=e.target.value} />
                    ...
                    <div class="col-md-6 mb-4 pb-2">
                      ...
                      <label class="form-label" for="form3Examplev3">Confirm password</label>
                        <input type="password" id="form3Examplev3" class="form-control form-control-lg" onBlur={(e)=>pass2=e.target.value}/>
                  ...
                  <select name="cars" id="cars" onChange={(e)=>role1=e.target.value}>
              ...
              <div class="col-lg-6 bg-primary-subtle">
                <div class="p-5">
